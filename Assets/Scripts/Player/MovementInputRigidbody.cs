...
public class MovementInputRigidbody : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        rb.AddForce(desiredMoveDirection.normalized * velocity, ForceMode.Impulse);
    }
    ...
    void PlayerMoveAndRotation() {
		...
		if (blockRotationPlayer == false) {
            ...
            //rb.MovePosition(desiredMoveDirection.normalized * Time.deltaTime * velocity);
		}
	}
    ...
    void InputMagnitude() {
        ...
        if (Speed == 0) desiredMoveDirection = Vector3.zero;
